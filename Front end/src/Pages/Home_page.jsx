        ...
        <>
            ...
            <div className="sidebarContainer">
                <ul className="sidebar-ul">
                    <NavLink to="/" className={({ isActive }) => isActive ? "active-sidbarLink" : ""}>
                        <li><i className="fa-solid fa-house"></i> Home</li>
                    </NavLink>
                    <NavLink to="create-post" className={({ isActive }) => isActive ? "active-sidebarLink" : ""}>
                        <li><i className="fa-solid fa-plus"></i> Create</li>
                    </NavLink>
                    <NavLink to="your-questions" className={({ isActive }) => isActive ? "active-sidebarLink" : ""}>
...
// {/* <li><i className="fa-solid fa-signs-post"></i> Your Questions</li> 
//                     <li><i className="fa-solid fa-comment"></i>  Your Answers</li>  */}